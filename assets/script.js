...
var taskFormHandler = function(event) {
    ...
    var taskNameInputIsEmpty = !taskNameInput //false
    var taskTypeInputIsEmpty = !taskTypeInput //false

    //check if input values are empty strings
    if (taskNameInputIsEmpty || taskTypeInputIsEmpty) {
...
var completeEditTask = function(taskName, taskType, taskId) {
    //find the matching task to list item
    ...
    //removed data attribute from form
...
var createTaskEl = function(taskDataObj) {
    ...
    //create div to hold task ingo and add to list item
...
var editTask = function(taskId) {
    ...
    //set data attribute to the form with a value of the task's id so it know which one is being edited
